...
`,c=()=>(0,a.jsxs)(l,{children:[(0,a.jsx)(m,Object.assign({to:"/astray"},{children:"astray"})),(0,a.jsx)(d,Object.assign({to:"https://t.me/Sadlineee",target:"_blank"},{children:(0,a.jsx)(n.hFS,{})}))]})},207:(e,i,t)=>{t.r(i),t.d(i,{AttractionBox:()=>j,default:()=>A});var a=t(848),n=t(464),r=t(264),s=t(581),o=t(594);const l=s.Ay.div`
  display: flex;
...
`,h=s.Ay.hr`
  width: 5%;
  margin: 1.5rem 0;
  border: 2px solid ${o.w.colors.primary};
  border-radius: 50px;
...
`,x=({el:e})=>{const i=[{title:"История",content:e.history},{title:"Архитектура",content:e.architecture}];return(0,a.jsxs)(l,{children:[(0,a.jsx)(m,{children:e.title}),i.map((({title:e,content:i})=>(0,a.jsxs)(d,{children:[(0,a.jsx)(c,{children:e}),(0,a.jsx)(h,{}),(0,a.jsx)(f,{children:i})]},e)))]},e.id)};var p=t(457);const y=s.Ay.div`
  display: flex;
  flex-direction: row;
  width: calc(50vh * 10);
...
`,g=({el:e})=>(0,a.jsx)(y,{children:[...e.image,...e.image].map(((i,t)=>(0,a.jsx)(w,{children:(0,a.jsx)(p.Ay,{src:i,alt:"attraction"})},`${e.id}-${t}`)))},e.id),j=s.Ay.main`
  overflow: hidden;
...
`,A=({data:e})=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(n.Ay,{}),(0,a.jsx)(j,{children:e.map((e=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(g,{el:e},e.id),(0,a.jsx)(x,{el:e},e.id)]})))}),(0,a.jsx)(r.Ay,{})]})}}]);