...
export const TowerOfLondonData: AboutAttractionProps[] = [
  ...
  { 
    ...
    description: 'Лондонский Тауэр – один из самых знаменитых исторических памятников Великобритании, расположенный на северном берегу реки Темзы в центре Лондона. Он известен своей богатой историей, загадочными легендами и значимостью как королевская резиденция, крепость и тюрьма.',
